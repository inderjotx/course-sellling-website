...
export function ChapterDescriptionForm({ description, chapterId, courseId }: { description: string, courseId: number, chapterId: number }) {
    ...
    const handleUpdate = async () => {
        ...
        setEditable(false)
        const response = await updateChapter(courseId, chapterId, "description", courseDescription,)
    ...
    return (
        <div className='bg-blue-100/50 flex rounded-sm  flex-col gap-6 px-6 py-5 '>
            ...
            <div>
                ...
                {
                    editable ?
                        <div className='flex flex-col bg-blue-100/50 gap-3'>
                            <Editor value={courseDescription} setValue={(value: string) => setCourseDescription(value)} />
                            <div>
